...
/**
 * CustomerTokenStatusUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  Klarna\Payments
 * @author   OpenAPI Generator team
 ...
 */
class CustomerTokenStatusUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customer_token_status_update_request';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status The token status to update to.
     *
     * @return self
     */
